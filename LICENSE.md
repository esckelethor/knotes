...
This software and all associated files in this repository are the exclusive property of the copyright holder. Permission is granted only for the purpose of viewing and reviewing the code as part of a professional portfolio evaluation

**Strictly prohibited actions include, but are not limited to:**
- Redistribution, sublicensing, or selling the source code or binaries
- Modification of the code for any purpose other than personal study
- Use of the software, in whole or in part, for any commercial purposes or for-profit ventures
- Hosting or deploying this application on any public or private server for production use
...
Este software y todos los archivos asociados en este repositorio son propiedad exclusiva del titular del copyright. Se concede permiso únicamente con el propósito de visualizar y revisar el código como parte de una evaluación de portafolio profesional

**Las acciones estrictamente prohibidas incluyen, pero no se limitan a:**
- La redistribución, sublicenciamiento o venta del código fuente o de los archivos binarios
- La modificación del código para cualquier propósito que no sea el estudio personal
- El uso del software, total o parcialmente, para cualquier fin comercial o emprendimiento con fines de lucro
- El alojamiento o despliegue de esta aplicación en cualquier servidor público o privado para su uso en producción

**Aviso Legal de Terceros:**

Este proyecto integra servicios y APIs proporcionados por terceros, incluyendo, entre otros, ***Spotify***, ***shields badges***, ***GitHub***, ***GitHub Pages*** y ***GitHub Projects***. Todas las marcas comerciales, logotipos y nombres de marca son propiedad de sus respectivos dueños. El uso de estos servicios no implica ninguna afiliación o respaldo por parte de los mismos. Estos componentes se utilizan estrictamente con fines de integración y demostración dentro de la aplicación y están sujetos a sus propios términos de servicio y licencias correspondientes

Para consultas relacionadas con licencias comerciales o permisos adicionales, por favor contacte en:
- LinkedIn: **[yeza](https://www.linkedin.com/in/christian-yezallell-angel-fernandez-736923330/)** / **[yai](https://www.linkedin.com/in/yaiza-priscila-angel-fernandez-aaa9b4146/)**
- GitHub: **[esckelethor](https://github.com/esckelethor)** / **[yaiangel13](https://github.com/yaiangel13)**
- Discord: **esckelethor** / **yaiangel**
